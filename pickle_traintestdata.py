...
import create_symbol_train_data as c
import pickle

trainDataX, trainDataY = c.getTrainData([c.relative_path2011, c.relative_path2012])
testDataX, testDataY = c.getTrainData([c.relative_testpath2011, c.relative_testpath2012])
